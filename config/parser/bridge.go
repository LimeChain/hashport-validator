...
type Token struct {
	...
	FeeAmountInUsd    int64             `yaml:"fee_amount_in_usd" json:"feeAmountInUsd,omitempty"`        // Represent a dynamic fee for Non-Fungible tokens. Applies only for Hedera Native Tokens
