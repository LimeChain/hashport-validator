...
// FeeAmountFor is a free data retrieval call binding the contract method 0x4adb4989.
//
// Solidity: function feeAmountFor(uint256 _targetChain, address _userAddress, address _tokenAddress, uint256 _amount) view returns(uint256)
func (_Router *RouterCaller) FeeAmountFor(opts *bind.CallOpts, _targetChain *big.Int, _userAddress common.Address, _tokenAddress common.Address, _amount *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Router.contract.Call(opts, &out, "feeAmountFor", _targetChain, _userAddress, _tokenAddress, _amount)
...
//
// Solidity: function feeAmountFor(uint256 _targetChain, address _userAddress, address _tokenAddress, uint256 _amount) view returns(uint256)
func (_Router *RouterSession) FeeAmountFor(_targetChain *big.Int, _userAddress common.Address, _tokenAddress common.Address, _amount *big.Int) (*big.Int, error) {
	return _Router.Contract.FeeAmountFor(&_Router.CallOpts, _targetChain, _userAddress, _tokenAddress, _amount)
}

// FeeAmountFor is a free data retrieval call binding the contract method 0x4adb4989.
//
// Solidity: function feeAmountFor(uint256 _targetChain, address _userAddress, address _tokenAddress, uint256 _amount) view returns(uint256)
func (_Router *RouterCallerSession) FeeAmountFor(_targetChain *big.Int, _userAddress common.Address, _tokenAddress common.Address, _amount *big.Int) (*big.Int, error) {
	return _Router.Contract.FeeAmountFor(&_Router.CallOpts, _targetChain, _userAddress, _tokenAddress, _amount)
}

// GetUsersFeePolicyAddress is a free data retrieval call binding the contract method 0xffafd727.
//
// Solidity: function getUsersFeePolicyAddress(address _userAddress) view returns(address)
func (_Router *RouterCaller) GetUsersFeePolicyAddress(opts *bind.CallOpts, _userAddress common.Address) (common.Address, error) {
	var out []interface{}
	err := _Router.contract.Call(opts, &out, "getUsersFeePolicyAddress", _userAddress)
...
//
// Solidity: function getUsersFeePolicyAddress(address _userAddress) view returns(address)
func (_Router *RouterSession) GetUsersFeePolicyAddress(_userAddress common.Address) (common.Address, error) {
	return _Router.Contract.GetUsersFeePolicyAddress(&_Router.CallOpts, _userAddress)
}

// GetUsersFeePolicyAddress is a free data retrieval call binding the contract method 0xffafd727.
//
// Solidity: function getUsersFeePolicyAddress(address _userAddress) view returns(address)
func (_Router *RouterCallerSession) GetUsersFeePolicyAddress(_userAddress common.Address) (common.Address, error) {
	return _Router.Contract.GetUsersFeePolicyAddress(&_Router.CallOpts, _userAddress)
}
...
func (_Router *RouterTransactor) BurnERC721(opts *bind.TransactOpts, _targetChain *big.Int, _wrappedToken common.Address, _tokenId *big.Int, _paymentToken common.Address, _fee *big.Int, _receiver []byte) (*types.Transaction, error) {
	return _Router.contract.Transact(opts, "burnERC721", _targetChain, _wrappedToken, _tokenId, _paymentToken, _fee, _receiver)
}
...
func (_Router *RouterSession) BurnERC721(_targetChain *big.Int, _wrappedToken common.Address, _tokenId *big.Int, _paymentToken common.Address, _fee *big.Int, _receiver []byte) (*types.Transaction, error) {
	return _Router.Contract.BurnERC721(&_Router.TransactOpts, _targetChain, _wrappedToken, _tokenId, _paymentToken, _fee, _receiver)
}
...
// Lock is a paid mutator transaction binding the contract method 0xfb3d8bd2.
//
// Solidity: function lock(uint256 _targetChain, address _nativeToken, uint256 _amount, bytes _receiver, uint256 _serviceFee) returns()
func (_Router *RouterTransactor) Lock(opts *bind.TransactOpts, _targetChain *big.Int, _nativeToken common.Address, _amount *big.Int, _receiver []byte, _serviceFee *big.Int) (*types.Transaction, error) {
	return _Router.contract.Transact(opts, "lock", _targetChain, _nativeToken, _amount, _receiver, _serviceFee)
}

// Lock is a paid mutator transaction binding the contract method 0xfb3d8bd2.
//
// Solidity: function lock(uint256 _targetChain, address _nativeToken, uint256 _amount, bytes _receiver, uint256 _serviceFee) returns()
func (_Router *RouterSession) Lock(_targetChain *big.Int, _nativeToken common.Address, _amount *big.Int, _receiver []byte, _serviceFee *big.Int) (*types.Transaction, error) {
	return _Router.Contract.Lock(&_Router.TransactOpts, _targetChain, _nativeToken, _amount, _receiver, _serviceFee)
}

// Lock is a paid mutator transaction binding the contract method 0xfb3d8bd2.
//
// Solidity: function lock(uint256 _targetChain, address _nativeToken, uint256 _amount, bytes _receiver, uint256 _serviceFee) returns()
func (_Router *RouterTransactorSession) Lock(_targetChain *big.Int, _nativeToken common.Address, _amount *big.Int, _receiver []byte, _serviceFee *big.Int) (*types.Transaction, error) {
	return _Router.Contract.Lock(&_Router.TransactOpts, _targetChain, _nativeToken, _amount, _receiver, _serviceFee)
}

// LockWithPermit is a paid mutator transaction binding the contract method 0x0824fd62.
//
// Solidity: function lockWithPermit(uint256 _targetChain, address _nativeToken, uint256 _amount, bytes _receiver, uint256 _deadline, uint256 _serviceFee, uint8 _v, bytes32 _r, bytes32 _s) returns()
func (_Router *RouterTransactor) LockWithPermit(opts *bind.TransactOpts, _targetChain *big.Int, _nativeToken common.Address, _amount *big.Int, _receiver []byte, _deadline *big.Int, _serviceFee *big.Int, _v uint8, _r [32]byte, _s [32]byte) (*types.Transaction, error) {
	return _Router.contract.Transact(opts, "lockWithPermit", _targetChain, _nativeToken, _amount, _receiver, _deadline, _serviceFee, _v, _r, _s)
}

// LockWithPermit is a paid mutator transaction binding the contract method 0x0824fd62.
//
// Solidity: function lockWithPermit(uint256 _targetChain, address _nativeToken, uint256 _amount, bytes _receiver, uint256 _deadline, uint256 _serviceFee, uint8 _v, bytes32 _r, bytes32 _s) returns()
func (_Router *RouterSession) LockWithPermit(_targetChain *big.Int, _nativeToken common.Address, _amount *big.Int, _receiver []byte, _deadline *big.Int, _serviceFee *big.Int, _v uint8, _r [32]byte, _s [32]byte) (*types.Transaction, error) {
	return _Router.Contract.LockWithPermit(&_Router.TransactOpts, _targetChain, _nativeToken, _amount, _receiver, _deadline, _serviceFee, _v, _r, _s)
}

// LockWithPermit is a paid mutator transaction binding the contract method 0x0824fd62.
//
// Solidity: function lockWithPermit(uint256 _targetChain, address _nativeToken, uint256 _amount, bytes _receiver, uint256 _deadline, uint256 _serviceFee, uint8 _v, bytes32 _r, bytes32 _s) returns()
func (_Router *RouterTransactorSession) LockWithPermit(_targetChain *big.Int, _nativeToken common.Address, _amount *big.Int, _receiver []byte, _deadline *big.Int, _serviceFee *big.Int, _v uint8, _r [32]byte, _s [32]byte) (*types.Transaction, error) {
	return _Router.Contract.LockWithPermit(&_Router.TransactOpts, _targetChain, _nativeToken, _amount, _receiver, _deadline, _serviceFee, _v, _r, _s)
}
...
// RemoveUsersFeePolicy is a paid mutator transaction binding the contract method 0xcf33c799.
//
// Solidity: function removeUsersFeePolicy(address[] _userAddresses) returns()
func (_Router *RouterTransactor) RemoveUsersFeePolicy(opts *bind.TransactOpts, _userAddresses []common.Address) (*types.Transaction, error) {
	return _Router.contract.Transact(opts, "removeUsersFeePolicy", _userAddresses)
}

// RemoveUsersFeePolicy is a paid mutator transaction binding the contract method 0xcf33c799.
//
// Solidity: function removeUsersFeePolicy(address[] _userAddresses) returns()
func (_Router *RouterSession) RemoveUsersFeePolicy(_userAddresses []common.Address) (*types.Transaction, error) {
	return _Router.Contract.RemoveUsersFeePolicy(&_Router.TransactOpts, _userAddresses)
}

// RemoveUsersFeePolicy is a paid mutator transaction binding the contract method 0xcf33c799.
//
// Solidity: function removeUsersFeePolicy(address[] _userAddresses) returns()
func (_Router *RouterTransactorSession) RemoveUsersFeePolicy(_userAddresses []common.Address) (*types.Transaction, error) {
	return _Router.Contract.RemoveUsersFeePolicy(&_Router.TransactOpts, _userAddresses)
}
...
// SetUsersFeePolicy is a paid mutator transaction binding the contract method 0x5f39ef57.
//
// Solidity: function setUsersFeePolicy(address _feePolicyAddress, address[] _userAddresses) returns()
func (_Router *RouterTransactor) SetUsersFeePolicy(opts *bind.TransactOpts, _feePolicyAddress common.Address, _userAddresses []common.Address) (*types.Transaction, error) {
	return _Router.contract.Transact(opts, "setUsersFeePolicy", _feePolicyAddress, _userAddresses)
}

// SetUsersFeePolicy is a paid mutator transaction binding the contract method 0x5f39ef57.
//
// Solidity: function setUsersFeePolicy(address _feePolicyAddress, address[] _userAddresses) returns()
func (_Router *RouterSession) SetUsersFeePolicy(_feePolicyAddress common.Address, _userAddresses []common.Address) (*types.Transaction, error) {
	return _Router.Contract.SetUsersFeePolicy(&_Router.TransactOpts, _feePolicyAddress, _userAddresses)
}

// SetUsersFeePolicy is a paid mutator transaction binding the contract method 0x5f39ef57.
//
// Solidity: function setUsersFeePolicy(address _feePolicyAddress, address[] _userAddresses) returns()
func (_Router *RouterTransactorSession) SetUsersFeePolicy(_feePolicyAddress common.Address, _userAddresses []common.Address) (*types.Transaction, error) {
	return _Router.Contract.SetUsersFeePolicy(&_Router.TransactOpts, _feePolicyAddress, _userAddresses)
}
...
// UnlockWithFee is a paid mutator transaction binding the contract method 0x82b201ed.
//
// Solidity: function unlockWithFee(uint256 _sourceChain, bytes _transactionId, address _nativeToken, uint256 _amount, address _receiver, uint256 _serviceFee, bytes[] _signatures) returns()
func (_Router *RouterTransactor) UnlockWithFee(opts *bind.TransactOpts, _sourceChain *big.Int, _transactionId []byte, _nativeToken common.Address, _amount *big.Int, _receiver common.Address, _serviceFee *big.Int, _signatures [][]byte) (*types.Transaction, error) {
	return _Router.contract.Transact(opts, "unlockWithFee", _sourceChain, _transactionId, _nativeToken, _amount, _receiver, _serviceFee, _signatures)
}

// UnlockWithFee is a paid mutator transaction binding the contract method 0x82b201ed.
//
// Solidity: function unlockWithFee(uint256 _sourceChain, bytes _transactionId, address _nativeToken, uint256 _amount, address _receiver, uint256 _serviceFee, bytes[] _signatures) returns()
func (_Router *RouterSession) UnlockWithFee(_sourceChain *big.Int, _transactionId []byte, _nativeToken common.Address, _amount *big.Int, _receiver common.Address, _serviceFee *big.Int, _signatures [][]byte) (*types.Transaction, error) {
	return _Router.Contract.UnlockWithFee(&_Router.TransactOpts, _sourceChain, _transactionId, _nativeToken, _amount, _receiver, _serviceFee, _signatures)
}

// UnlockWithFee is a paid mutator transaction binding the contract method 0x82b201ed.
//
// Solidity: function unlockWithFee(uint256 _sourceChain, bytes _transactionId, address _nativeToken, uint256 _amount, address _receiver, uint256 _serviceFee, bytes[] _signatures) returns()
func (_Router *RouterTransactorSession) UnlockWithFee(_sourceChain *big.Int, _transactionId []byte, _nativeToken common.Address, _amount *big.Int, _receiver common.Address, _serviceFee *big.Int, _signatures [][]byte) (*types.Transaction, error) {
	return _Router.Contract.UnlockWithFee(&_Router.TransactOpts, _sourceChain, _transactionId, _nativeToken, _amount, _receiver, _serviceFee, _signatures)
}
