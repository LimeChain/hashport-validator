...
func Load() *Setup {
	...
	setup.AssetMappings = assets.NewService(&e2eConfig.Bridge, configuration.FeePercentages, routerClients, setup.Clients.MirrorNode, evmFungibleTokenClients, evmNftClients)
