...
func NewConsensusTopicWatcher(nodeClient client.HederaNode, mirrorClient client.MirrorNode, topicID hedera.TopicID, repository repository.Status, maxRetries int, startTimestamp int64) *ConsensusTopicWatcher {
