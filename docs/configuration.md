...
`validator.clients.hedera.fee_percentage`                           | 10                                                  | The percentage  which validators take for every bridge transfer (e.g. 10% of Bridge Transfer).
`validator.clients.hedera.validators[]`                             | []                                                  | The Hedera account ids of the validators, to which their bridge fees will be sent (if Bridge accepts Hedera Tokens, associations with these tokens will be required)
