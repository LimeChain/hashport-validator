...
type LockEvent interface {
	// TODO: Refactor this to fit whatever LockEvent provides
	...
	// Returns LockEvent by its Id (represented in {ethTxHash}-{logIndex})
	Get(txId string) (*entity.LockEvent, error)
}
