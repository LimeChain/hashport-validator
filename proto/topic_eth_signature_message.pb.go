...
type TopicEthSignatureMessage struct {
	...
	TargetAsset     string `protobuf:"bytes,7,opt,name=targetAsset,proto3" json:"targetAsset,omitempty"`         // The target asset
}
...
func (x *TopicEthSignatureMessage) GetTargetAsset() string {
	if x != nil {
...
var file_topic_eth_signature_message_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf4, 0x01, 0x0a, 0x18, 0x54,
	...
	0x20, 0x0a, 0x0b, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x41, 0x73, 0x73, 0x65, 0x74, 0x18, 0x07,
